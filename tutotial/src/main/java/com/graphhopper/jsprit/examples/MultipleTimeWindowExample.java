...
public class MultipleTimeWindowExample {
    ...
    public static void main(String[] args) {
    	...
    	VehicleRoutingProblem.Builder vrpBuilder = VehicleRoutingProblem.Builder.newInstance();
    	 ...
    	 //new VrpXMLReader(vrpBuilder).read("C:\\Users\\malla\\eclipse-workspace\\tutotial\\src\\main\\java\\com\\graphhopper\\jsprit\\examples\\cordeau01.xml");
        ...
        vehicleBuilder.addSkill("Driver1");
        VehicleImpl vehicle = vehicleBuilder.build();
        
        
        Builder vehicleBuilder2 = Builder.newInstance("vehicle2");
        vehicleBuilder2.setStartLocation(Location.newInstance(50, 8));
        vehicleBuilder2.setType(vehicleType);
        vehicleBuilder2.addSkill("Driver2");
...
//            .addTimeWindow(5,10)
        ...
        Service service5 = Service.Builder.newInstance("5")
            ...
            .addSizeDimension(WEIGHT_INDEX, 1).setLocation(Location.newInstance(50, 0)).build();


        VehicleRoutingProblem.Builder vrpBuilder1 = VehicleRoutingProblem.Builder.newInstance();
        vrpBuilder1.addVehicle(vehicle);
        vrpBuilder1.addVehicle(vehicle2);
        vrpBuilder1.addJob(service1).addJob(service2)
            .addJob(service3)
            .addJob(service4)
            .addJob(service5)
        ;
        vrpBuilder1.setFleetSize(VehicleRoutingProblem.FleetSize.FINITE);
        vrpBuilder1.setRoutingCost(new ManhattanCosts());
        VehicleRoutingProblem problem = vrpBuilder1.build();
...
//        new VrpXMLWriter(problem, solutions).write("output/problem-with-solution.xml");
         ...
         * plot
		 */
        VehicleRoutingProblem vrp = vrpBuilder1.build();
